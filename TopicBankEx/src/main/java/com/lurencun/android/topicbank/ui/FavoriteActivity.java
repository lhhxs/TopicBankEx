...
import com.lurencun.android.topicbank.res.FavoriteAdapter;
import com.lurencun.android.topicbank.res.FavoriteLoader;
 ...
 * @date 2012-2-24
 */
public class FavoriteActivity extends BackUIActivity {
	...
	protected void onCreateEx(Bundle savedInstanceState) {
		...
		CommonAdapter<CategoryEntity> adapter = new FavoriteAdapter(this);
		final List<CategoryEntity> data = new FavoriteLoader(this).load(value);
		if(data == null || data.size() <= 0){Toast.makeText(getApplicationContext(), "没有收藏！",
			...
			list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
	                ...
	                bundle.putInt("tiku", data.get(arg2).id);
	                bundle.putString("biao","shouchang");
	                Log.e("TAG>>>>", "tiku,biao " +bundle.getInt("tiku")+bundle.getString("biao"));
	                myIntent.putExtras(bundle);
	                myIntent.setClass(FavoriteActivity.this,ExtraTopicActivity.class);
