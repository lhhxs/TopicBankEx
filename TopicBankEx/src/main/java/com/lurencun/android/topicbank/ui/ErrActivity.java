...
import com.lurencun.android.topicbank.res.ErrAdapter;
import com.lurencun.android.topicbank.res.ErrLoader;
 ...
 * @date 2012-2-24
 */
public class ErrActivity extends BackUIActivity {
	...
	protected void onCreateEx(Bundle savedInstanceState) {
		...
		CommonAdapter<CategoryEntity> adapter = new ErrAdapter(this);
		final List<CategoryEntity> data = new ErrLoader(this).load(value);
		if(data == null || data.size() <= 0){Toast.makeText(getApplicationContext(), "没有错题！",
			...
			list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
	                ...
	                bundle.putString("biao","cuoti");
	                Log.e("TAG>>>>", "tiku,biao " +bundle.getInt("tiku")+bundle.getString("biao"));
	                myIntent.putExtras(bundle);
	                myIntent.setClass(ErrActivity.this,ExtraTopicActivity.class);
