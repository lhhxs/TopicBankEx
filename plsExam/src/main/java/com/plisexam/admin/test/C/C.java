package com.plisexam.admin.test.C;
...
public final class C {
    ...
    public static final class dir {
        public static final String base				= "/sdcard/jingyongtiku";
        ...
        public static final String examInfofileName         = "examInfo";
    }

    public static final class api {
        public static final String base				= "http://192.168.0.103:8001/";
    ...
    public static final class intent {
        public static final class action {
            public static final String EDITTEXT		= "com.plsexam.admin.plsexam.EDITTEXT";
            public static final String EDITBLOG		= "com.plsexam.admin.plsexam.EDITBLOG";
        }
    }
    ...
    public static final void getUserfromshare()
    {
