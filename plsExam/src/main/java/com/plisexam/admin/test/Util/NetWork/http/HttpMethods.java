...
import com.plisexam.admin.test.Util.NetWork.HttpServers.LoginIndex;
import com.plisexam.admin.test.Util.NetWork.HttpServers.LoginService;
import com.plisexam.admin.test.Util.NetWork.HttpServers.ShiTiService;
...
public class HttpMethods {
    ...
    public static final String BASE_URL = "http://192.168.10.22:8001/";
...
//                .subscribe(subscriber);
     ...
     * @param pageid page
     */
    public void getShiTibyPage(Subscriber<ResultReturn> subscriber, String sid, String pageid){


        shiTiService = retrofit.create(ShiTiService.class);
        Observable observable = shiTiService.getShiTiByPage(sid, pageid)
                .map(new HttpResultFunc<Result<Timu>>());
